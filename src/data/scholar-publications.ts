...
/** Snapshot of profile metrics from Google Scholar (2026-09-19). */
...
export const scholarPublications: ScholarPublication[] = [
  { title: 'Inteligência artificial na educação', url: `${scholar}hSP8J9EAAAAJ:8k81kl-MbHgC`, authors: 'S Santos, CD Guimarães, EB dos Santos Filho, LF Gomes, LP de Castilho, ...', venue: 'Revista Contemporânea 4 (1), 1850–1870', citations: 38, year: '2024' },
  { title: 'Ciclo PDCA aplicado à educação: uma revisão de literatura', url: `${scholar}hSP8J9EAAAAJ:u-x6o8ySG0sC`, authors: 'SMAV Santos, CS de Araujo, CE do Nascimento, EB dos Santos Filho, ...', venue: 'Revista Amor Mundi 4 (4), 15-21', citations: 8, year: '2023' },
  { title: 'Combating school dropout with Artificial Intelligence in Brazilian higher education', url: `${scholar}hSP8J9EAAAAJ:Se3iqnhoufwC`, authors: 'MBN Meroto, AS Franqueira, CLC de Queiróz, EB dos Santos Filho, ...', venue: 'Contribuciones a las ciencias sociales 17 (2), e5182', citations: 7, year: '2024' },
  { title: 'ESAA: Event sourcing for autonomous agents in LLM-based software engineering', url: `${scholar}hSP8J9EAAAAJ:3fE2CSJIrl8C`, authors: 'EB dos Santos Filho', venue: 'arXiv preprint arXiv:2602.23193', citations: 6, year: '2026' },
  ...
  { title: 'As contribuições das Tecnologias Digitais da Informação e Comunicação (TDICs) para a psicopedagogia no processo de ensino-aprendizagem', url: `${scholar}hSP8J9EAAAAJ:Y0pCki6q_DkC`, authors: 'SMAV Santos, EB dos Santos Filho, FF Rodrigues, JM Medeiros, ...', venue: 'Educação Contemporânea: temas emergentes em diferentes perspectivas …', citations: 3, year: '2023' },
  { title: 'ESAA-Conversational: An Event-Sourced Memory Layer for Continuity, Handoff, and Curation Across Heterogeneous LLM Coding Agents', url: `${scholar}hSP8J9EAAAAJ:4TOpqqG69KYC`, authors: 'EB dos Santos Filho', venue: 'arXiv preprint arXiv:2606.23752', citations: 2, year: '2026' },
  { title: 'ESAA-Security: An Event-Sourced, Verifiable Architecture for Agent-Assisted Security Audits of AI-Generated Code', url: `${scholar}hSP8J9EAAAAJ:KlAtU1dfN6UC`, authors: 'EB dos Santos Filho', venue: 'arXiv preprint arXiv:2603.06365', citations: 2, year: '2026' },
  ...
  { title: 'Liderança e estratégias na era digital: um novo cenário', url: `${scholar}hSP8J9EAAAAJ:YsMSGLbcyi4C`, authors: 'CS de Araujo, CE do Nascimento, EB dos Santos Filho, ...', venue: 'Revista Amor Mundi 4 (11), 53-58', citations: 1, year: '2023' },
  ...
  { title: 'As implicações da inteligência artificial dentro da educação online', url: `${scholar}hSP8J9EAAAAJ:roLk4NBRz8UC`, authors: 'F Gonçalves, EG Lira, EB dos Santos Filho, LCB Santos, S da Silva', venue: 'Revista Amor Mundi 5 (2), 99-105', citations: 0, year: '2024' },
  ...
  { title: 'A geração screenagers e os desafios para a educação: reflexões sobre a era digital nas instituições escolares', url: `${scholar}hSP8J9EAAAAJ:2osOgNQ5qMEC`, authors: 'EG Lira, EB dos Santos Filho, F Gonçalves, LCBS Santos, S da Silva', venue: 'Revista Amor Mundi 4 (6), 125-133', citations: 0, year: '2023' },
