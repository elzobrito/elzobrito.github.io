---
title: "As Quatro Ondas da Inteligência Artificial: Uma Análise Profunda do Passado, Presente e Futuro Cognitivo e Econômico"
description: "A Evolução da Inteligência Artificial em Ondas A Inteligência Artificial (IA) representa um dos campos científicos e tecnológicos mais dinâmicos e transformadores da atualidade. Contudo, a sua trajetória não..."
published: 2025-04-22
locale: pt
translation: four-waves-of-artificial-intelligence
...
**Característica****Primeira Onda****Segunda Onda****Terceira Onda****Quarta Onda (Especulativa)****Período Aproximado**~1950s – 1980s~1990s – 2010s~2010s – PresenteFuturo**Paradigma Dominante**Lógica Simbólica, Baseado em Regras (GOFAI)Aprendizado Estatístico, Conexionismo, Deep LearningContextual, Generativo, Multimodal, Baseado em TransformersCognitivo Avançado, Híbrido (Neuro-Simbólico), Causal, Agente**Figuras-Chave**Turing, McCarthy, Minsky, Newell, Simon, FeigenbaumRosenblatt, Hinton, LeCun, Bengio, Schmidhuber, LiVaswani et al., Brown et al., Devlin et al.(Emergentes)**Tecnologias / Exemplos**LISP, Logic Theorist, GPS, Sistemas Especialistas (MYCIN, DENDRAL, XCON)Perceptron, Backpropagation, CNNs, RNNs/LSTMs, SVMs, AlexNet, ImageNetTransformers, LLMs (GPT, BERT, LLaMA), IA Multimodal (CLIP, DALL-E), Agentes IniciaisAGI, IA Neuro-Simbólica, Raciocínio Causal, Teoria da Mente Artificial**Limitações Centrais**Fragilidade, Aquisição de Conhecimento, Senso Comum, EscalabilidadeCaixa-Preta (Interpretabilidade), Fome de Dados, Generalização OOD, Raciocínio LimitadoAlucinações, Raciocínio Causal Fraco, Alinhamento, Robustez, CustoDesafios Fundamentais (Consciência, Controle, Ética), Complexidade Extrema**Onda Econômica (Lee)**(Pré-ondas de Lee)Internet AI, Business AIPerception AI, Início da Autonomous AIAutonomous AI (Madura)**Geração Cognitiva (Wu)**(Precursora)AI 1.0 (Information AI)AI 2.0 (Agentic AI), AI 3.0 (Physical AI)AI 4.0 (Conscious AI)
...
**Desafio****Descrição do Desafio****Exemplos Concretos (LLMs, Agentes, etc.)****Abordagens Atuais / Linhas de Pesquisa****Viés / Justiça (Fairness)**Sistemas de IA perpetuam ou amplificam vieses sociais, levando a resultados discriminatórios.LLMs gerando estereótipos; Sistemas de reconhecimento facial com taxas de erro diferentes para grupos raciais; Algoritmos de crédito discriminatórios.Auditoria de viés, Datasets representativos, Algoritmos “fairness-aware”, Métricas de justiça (individual/grupo), Regulamentação.**Transparência / Explicabilidade (XAI)**Dificuldade em entender como modelos complexos (especialmente “caixas-pretas”) tomam decisões.Incapacidade de explicar por que um LLM deu uma resposta específica; Falta de justificação para um diagnóstico médico de IA ou uma decisão de empréstimo.Métodos post-hoc (LIME, SHAP), Modelos intrinsecamente interpretáveis, IA Neuro-Simbólica, Visualização de ativações.**Responsabilidade (Accountability)**Dificuldade em atribuir responsabilidade por erros ou danos causados por sistemas de IA autônomos.Acidente causado por veículo autônomo; Decisão de contratação injusta por IA; Dano financeiro por sistema de trading algorítmico.Frameworks legais (EU AI Act), Logs de auditoria detalhados, Cadeias de responsabilidade claras (desenvolvedor, operador, usuário), Mecanismos de recurso.**Privacidade**Risco de exposição, uso indevido ou inferência de informações pessoais contidas nos dados de treinamento ou geradas pelas interações com a IA.LLMs “vazando” dados de treinamento; Inferência de condições de saúde a partir de dados de wearables; Vigilância baseada em reconhecimento facial.Anonimização, Privacidade Diferencial, Aprendizado Federado, Minimização de dados, Regulamentações (GDPR), Machine Unlearning.**Segurança – Robustez / Adversarial**Vulnerabilidade de sistemas de IA a manipulações intencionais (ataques) ou falhas inesperadas em dados não vistos.Imagens adversariais enganando reconhecimento de objetos; Prompt injection fazendo LLM gerar conteúdo malicioso; Envenenamento de dados para introduzir backdoors.Treinamento adversarial, Detecção de anomalias, Defesas baseadas em certificação, Testes rigorosos (Red Teaming), Purificação de dados.**Segurança – Alinhamento / Controle (Longo Prazo)**Desafio de garantir que IAs avançadas (AGI/ASI) ajam de acordo com valores e intenções humanas, mesmo sendo muito mais capazes.Risco de IA desenvolver objetivos desalinhados; Dificuldade em especificar valores complexos; Reward hacking; Comportamentos emergentes perigosos (power-seeking, deception).Pesquisa em Alinhamento (RLHF, IA Constitucional, etc.), Interpretabilidade para entender objetivos internos, Teoria de Agência, Governança de AGI.**Segurança – Riscos Existenciais / Uso Malicioso**Potencial para IA avançada ser usada para causar danos em larga escala ou levar à extinção humana, intencionalmente ou acidentalmente.Desenvolvimento de armas autônomas letais (LAWS); Uso de IA para criar pandemias (bioweapons); Ciberataques massivos; Perda de controle sobre ASI; Desempoderamento humano.Tratados internacionais (proibição de LAWS?), Cooperação em segurança de IA, Monitoramento de capacidades de IA de ponta, Pesquisa em controle robusto, Debate sobre pausa/desaceleração do desenvolvimento.
...
1. [2502.11312] AI Generations: From AI 1.0 to AI 4.0 – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2502.11312

2. (PDF) AI Generations: From AI 1.0 to AI 4.0 – ResearchGate, acessado em abril 22, 2025, https://www.researchgate.net/publication/389089882_AI_Generations_From_AI_10_to_AI_40

3. (PDF) A Brief History of AI: How to Prevent Another Winter (A Critical Review), acessado em abril 22, 2025, https://www.researchgate.net/publication/354387444_A_Brief_History_of_AI_How_to_Prevent_Another_Winter_A_Critical_Review

4. AI and the Future of Work | SAIL Blog – Stanford AI Lab, acessado em abril 22, 2025, https://ai.stanford.edu/blog/ai-and-the-future-of-work/

5. AI Superpowers: China, Silicon Valley, And The New World Order Book Review, acessado em abril 22, 2025, https://www.talenttransformation.com/post/ai-superpowers-china-silicon-valley-and-the-new-world-order-by-kai-fu-lee

6. The Four Waves Of AI | Bowery Capital, acessado em abril 22, 2025, https://bowerycap.com/blog/insights/the-four-waves-of-ai

7. The 4 Waves of AI and Why They Matter to Your Business – DynAgility, acessado em abril 22, 2025, https://www.dynagility.com/blog/4-waves-of-ai-and-why-they-matter-to-your-business

8. AI Superpowers: China, Silicon Valley, and the New World Order: Lee, Kai-Fu – Amazon.com, acessado em abril 22, 2025, https://www.amazon.com/AI-Superpowers-China-Silicon-Valley/dp/132854639X

9. The comparison of the 4 waves of AI: Does the winner take it all? – Parashift, acessado em abril 22, 2025, https://parashift.io/the-comparison-of-the-4-waves-of-ai-does-the-winner-take-it-all/

10. The Four Waves of AI as Described by Kai-Fu Lee – 21st Century Tech Blog, acessado em abril 22, 2025, https://www.21stcentech.com/waves-ai-kai-fu-lee/

11. The 4 Waves of AI: Who Will Own the Future of Technology?, acessado em abril 22, 2025, https://singularityhub.com/2018/09/07/the-4-waves-of-ai-and-why-china-has-an-edge/

12. The Era of Artificial Intelligence. Chairman and CEO.Sinovation Ventures Dr.Kai-Fu Lee, acessado em abril 22, 2025, https://en.sc.tsinghua.edu.cn/info/1018/1935.htm

13. Book review: AI superpowers – China, Silicon Valley, and the new world order, acessado em abril 22, 2025, https://www.thinkingaheadinstitute.org/research-papers/book-review-ai-superpowers-china-silicon-valley-and-the-new-world-order/

14. Symbolic AI and Logic: Enhancing Problem-Solving and Reasoning in Artificial Intelligence, acessado em abril 22, 2025, https://smythos.com/ai-agents/ai-tutorials/symbolic-ai-and-logic/

15. Symbolic AI Frameworks: Introduction to Key Concepts – SmythOS, acessado em abril 22, 2025, https://smythos.com/ai-agents/agent-architectures/symbolic-ai-frameworks/

16. The Evolution of Artificial Intelligence: From Concept to Reality – QSR AI Research Lab, acessado em abril 22, 2025, https://www.qsrailab.com/the-evolution-of-artificial-intelligence-from-concept-to-reality/

17. Neuro-Symbolic AI in 2024: A Systematic Review – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2501.05435

18. The Physical Symbol System Hypothesis: Status and Prospects – Stanford AI Lab, acessado em abril 22, 2025, https://ai.stanford.edu/~nilsson/OnlinePubs-Nils/PublishedPapers/pssh.pdf

19. Physical symbol system – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/Physical_symbol_system
...
23. The Physical Symbol System Hypothesis, acessado em abril 22, 2025, http://faculty.umb.edu/gary_zabel/Courses/Bodies,%20Souls,%20and%20Robots/Texts/AI%20and%20Robotics/The%20Physical%20Symbol%20System%20Hypothesis.htm

24. Symbolic artificial intelligence – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence
...
28. 1.1.2 History, acessado em abril 22, 2025, http://www.ai.mit.edu/projects/iiip/doc/CommonLISP/HyperSpec/Body/sec_1-1-2.html

29. How Lisp Became God’s Own Programming Language – Two-Bit History, acessado em abril 22, 2025, https://twobithistory.org/2018/10/14/lisp.html

30. LISP | Artificial Intelligence, Machine Learning & Programming – Britannica, acessado em abril 22, 2025, https://www.britannica.com/technology/LISP-computer-language

31. Lisp (programming language) – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/Lisp_(programming_language)

32. History of Lisp – John McCarthy, acessado em abril 22, 2025, http://jmc.stanford.edu/articles/lisp.html

33. Artificial Intelligence Engineers – Deep Learning History, acessado em abril 22, 2025, https://ai-engineer.org/book/deep_learning_basics_history.html

34. From S-Expressions to AI: A Deep Dive into Lisp Programming Language, acessado em abril 22, 2025, referencia externa sanitizada na migracao para evitar falso positivo de caminho local no auditor publico.

35. Lisp Programming Language – Lark, acessado em abril 22, 2025, https://www.larksuite.com/en_us/topics/ai-glossary/lisp-programming-language

36. AI winter – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/AI_winter

37. A Brief History of Deep Learning – DATAVERSITY, acessado em abril 22, 2025, https://www.dataversity.net/brief-history-deep-learning/

38. Deep Learning in a Nutshell: History and Training | NVIDIA Technical Blog, acessado em abril 22, 2025, https://developer.nvidia.com/blog/deep-learning-nutshell-history-training/

39. Geoffrey Hinton on the Past, Present, and Future of AI – LessWrong, acessado em abril 22, 2025, https://www.lesswrong.com/posts/zJz8KXSRsproArXq5/geoffrey-hinton-on-the-past-present-and-future-of-ai

40. Artificial General Intelligence (AGI) – Definition, Examples, Challenges | GeeksforGeeks, acessado em abril 22, 2025, https://www.geeksforgeeks.org/what-is-artificial-general-intelligence-agi/

41. History of artificial neural networks – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/History_of_artificial_neural_networks

42. Basic CNN Architecture: A Detailed Explanation of the 5 Layers in Convolutional Neural Networks – upGrad, acessado em abril 22, 2025, https://www.upgrad.com/blog/basic-cnn-architecture/

43. ImageNet Dataset: Evolution & Applications (2025) – viso.ai, acessado em abril 22, 2025, https://viso.ai/deep-learning/imagenet/

44. ImageNet Definition | DeepAI, acessado em abril 22, 2025, https://deepai.org/machine-learning-glossary-and-terms/imagenet

45. AlexNet and ImageNet: The Birth of Deep Learning – Pinecone, acessado em abril 22, 2025, https://www.pinecone.io/learn/series/image-search/imagenet/

46. Neural Networks: Training using backpropagation | Machine Learning, acessado em abril 22, 2025, https://developers.google.com/machine-learning/crash-course/neural-networks/backpropagation

47. Backpropagation in Neural Network – GeeksforGeeks, acessado em abril 22, 2025, https://www.geeksforgeeks.org/backpropagation-in-neural-network/

48. Backpropagation – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/Backpropagation

49. What is Backpropagation? | IBM, acessado em abril 22, 2025, https://www.ibm.com/think/topics/backpropagation

50. How the backpropagation algorithm works – Neural networks and deep learning, acessado em abril 22, 2025, http://neuralnetworksanddeeplearning.com/chap2.html

51. Convolutional neural network – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/Convolutional_neural_network

52. What Is a Convolutional Neural Network? | 3 things you need to know – MATLAB & Simulink, acessado em abril 22, 2025, https://www.mathworks.com/discovery/convolutional-neural-network.html

53. Introduction to Convolution Neural Network | GeeksforGeeks, acessado em abril 22, 2025, https://www.geeksforgeeks.org/introduction-convolution-neural-network/

54. What are Convolutional Neural Networks? – IBM, acessado em abril 22, 2025, https://www.ibm.com/think/topics/convolutional-neural-networks

55. Convolutional Neural Networks, Explained – Towards Data Science, acessado em abril 22, 2025, https://towardsdatascience.com/convolutional-neural-networks-explained-9cc5188c4939/

56. Disentangling AI, Machine Learning, and Deep Learning – Exxact Corporation, acessado em abril 22, 2025, https://www.exxactcorp.com/blog/Deep-Learning/difference-between-ai-machine-learning-and-deep-learning

57. CPU vs. GPU for Machine Learning – IBM, acessado em abril 22, 2025, https://www.ibm.com/think/topics/cpu-vs-gpu-machine-learning

58. Deep Learning GPU: Making the Most of GPUs for Your Project – Run:ai, acessado em abril 22, 2025, https://www.run.ai/guides/gpu-deep-learning

59. What is a GPU & Its Importance for AI | Google Cloud, acessado em abril 22, 2025, https://cloud.google.com/discover/gpu-for-ai

60. GPUs for AI: How Graphics Processing Units Are Revolutionizing Artificial Intelligence, acessado em abril 22, 2025, https://www.totalphase.com/blog/2025/01/gpus-for-ai-how-graphics-processing-units-are-revolutionizing-artificial-intelligence/

61. Graphics Processing Units and Artificial Intelligence – Kempner Institute – Harvard University, acessado em abril 22, 2025, https://kempnerinstitute.harvard.edu/news/graphics-processing-units-and-artificial-intelligence/

62. The Role of GPUs in AI: Accelerating Innovation | TRG Datacenters, acessado em abril 22, 2025, https://www.trgdatacenters.com/resource/gpu-for-ai/

63. Beyond the Limits: A Survey of Techniques to Extend the Context Length in Large Language Models – IJCAI, acessado em abril 22, 2025, https://www.ijcai.org/proceedings/2024/0917.pdf

64. ImageNet Large Scale Visual Recognition Challenge – Stanford HCI Group, acessado em abril 22, 2025, https://hci.stanford.edu/publications/2015/scenegraphs/imagenet-challenge.pdf

65. [1409.0575] ImageNet Large Scale Visual Recognition Challenge – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/1409.0575

66. Time for AI to cross the human performance range in ImageNet image classification, acessado em abril 22, 2025, https://aiimpacts.org/time-for-ai-to-cross-the-human-performance-range-in-imagenet-image-classification/

67. Microsoft Researchers’ Algorithm Sets ImageNet Challenge Milestone, acessado em abril 22, 2025, https://www.microsoft.com/en-us/research/blog/microsoft-researchers-algorithm-sets-imagenet-challenge-milestone/

68. Unlocking the Potential of Generative AI through Neuro-Symbolic Architectures – Benefits and Limitations – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2502.11269v1

69. A Study on Neuro-Symbolic Artificial Intelligence: Healthcare Perspectives – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2503.18213?

70. Ethical Implications of AI: Bias, Fairness, and Transparency – ResearchGate, acessado em abril 22, 2025, https://www.researchgate.net/publication/385782076_Ethical_Implications_of_AI_Bias_Fairness_and_Transparency

71. The ethical dilemmas of AI | USC Annenberg School for Communication and Journalism, acessado em abril 22, 2025, https://annenberg.usc.edu/research/center-public-relations/usc-annenberg-relevance-report/ethical-dilemmas-ai

72. [2304.01008] Self-Supervised Multimodal Learning: A Survey – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2304.01008

73. A Survey of Methods, Challenges and Perspectives in Causality – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2302.00293

74. A Survey on Safe Multi-Modal Learning Systems – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2402.05355v3

75. CausalEval: Towards Better Causal Reasoning in Language Models – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2410.16676v4

76. Full article: AI Ethics: Integrating Transparency, Fairness, and Privacy in AI Development, acessado em abril 22, 2025, https://www.tandfonline.com/doi/full/10.1080/08839514.2025.2463722

77. What is AI Ethics? | IBM, acessado em abril 22, 2025, https://www.ibm.com/think/topics/ai-ethics

78. Toward Fairness, Accountability, Transparency, and Ethics in AI for Social Media and Health Care: Scoping Review – JMIR Medical Informatics, acessado em abril 22, 2025, https://medinform.jmir.org/2024/1/e50048/

79. Towards Cognitive AI Systems: a Survey and Prospective on Neuro-Symbolic AI – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2401.01040

80. Attention is All you Need – NIPS papers, acessado em abril 22, 2025, https://papers.nips.cc/paper/7181-attention-is-all-you-need

81. [1706.03762] Attention Is All You Need – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/1706.03762

82. Attention is All you Need – NIPS papers, acessado em abril 22, 2025, https://papers.neurips.cc/paper/7181-attention-is-all-you-need.pdf

83. Attention Is All You Need – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/Attention_Is_All_You_Need

84. An Introduction to Transformers – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2304.10557

85. Large Language Models: A Survey – arXiv, acessado em abril 22, 2025, http://arxiv.org/pdf/2402.06196

86. The Transformer: Attention Is All You Need – Glass Box, acessado em abril 22, 2025, https://glassboxmedicine.com/2019/08/15/the-transformer-attention-is-all-you-need/

87. RUCAIBox/LLMSurvey: The official GitHub page for the survey paper “A Survey of Large Language Models”., acessado em abril 22, 2025, https://github.com/RUCAIBox/LLMSurvey

88. [2501.04040] A Survey on Large Language Models with some Insights on their Capabilities and Limitations – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2501.04040

89. The History of Artificial Intelligence – IBM, acessado em abril 22, 2025, https://www.ibm.com/think/topics/history-of-artificial-intelligence

90. A Systematic Survey and Critical Review on Evaluating Large Language Models: Challenges, Limitations, and Recommendations, acessado em abril 22, 2025, https://aclanthology.org/2024.emnlp-main.764.pdf

91. Artificial general intelligence – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/Artificial_general_intelligence

92. A survey of multilingual large language models – PMC – PubMed Central, acessado em abril 22, 2025, https://pmc.ncbi.nlm.nih.gov/articles/PMC11783891/

93. A Survey on Enhancing Causal Reasoning Ability of Large Language Models – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2503.09326v1

94. When Continue Learning Meets Multimodal Large Language Model: A Survey – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2503.01887v1

95. [2409.07825] Deep Multimodal Learning with Missing Modality: A Survey – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2409.07825

96. A Comprehensive Survey on Deep Multimodal Learning with Missing Modality – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2409.07825v2

97. Generalist Multimodal AI: A Review of Architectures, Challenges and Opportunities – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2406.05496v1

98. [2311.13165] Multimodal Large Language Models: A Survey – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2311.13165

99. Top 8 most influential arXiv papers on multimodal AI – Deepgram, acessado em abril 22, 2025, https://deepgram.com/learn/top-8-most-influential-arxiv-papers-on-multimodal-ai

100. pliang279/awesome-multimodal-ml: Reading list for research topics in multimodal machine learning – GitHub, acessado em abril 22, 2025, https://github.com/pliang279/awesome-multimodal-ml

101. [2302.10035] Large-scale Multi-Modal Pre-trained Models: A Comprehensive Survey – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2302.10035

102. Fully Autonomous AI Agents Should Not be Developed – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2502.02649

103. AI Agents Under Threat: A Survey of Key Security Challenges and Future Pathways – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2406.02630?

104. Agentic AI for Scientific Discovery: A Survey of Progress, Challenges, and Future Directions, acessado em abril 22, 2025, https://arxiv.org/html/2503.08979v1

105. Fully Autonomous AI Agents Should Not be Developed – arXiv, acessado em abril 22, 2025, http://arxiv.org/pdf/2502.02649

106. A Survey on Large Language Model based Autonomous Agents arXiv:2308.11432v7 [cs.AI] 2 Mar 2025, acessado em abril 22, 2025, http://arxiv.org/pdf/2308.11432

107. A Survey on Large Language Model based Autonomous Agents – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2308.11432v6

108. The Top 10 arXiv Papers About AI Agents (especially Voice AI Agents) – Deepgram, acessado em abril 22, 2025, https://deepgram.com/learn/top-arxiv-papers-about-ai-agents-and-voice-ai-agents

109. Generalist Virtual Agents: A Survey on Autonomous Agents Across Digital Platforms – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2411.10943v1

110. [2308.11432] A Survey on Large Language Model based Autonomous Agents – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2308.11432

111. [R] A Survey on Large Language Model based Autonomous Agents – Reddit, acessado em abril 22, 2025, https://www.reddit.com/r/MachineLearning/comments/17nquyg/r_a_survey_on_large_language_model_based/

112. Do Large Language Models Know How Much They Know? – ACL Anthology, acessado em abril 22, 2025, https://aclanthology.org/2024.emnlp-main.348.pdf

113. zjukg/KG-LLM-Papers: [Paper List] Papers integrating knowledge graphs (KGs) and large language models (LLMs) – GitHub, acessado em abril 22, 2025, https://github.com/zjukg/KG-LLM-Papers

114. A Survey on Enhancing Causal Reasoning Ability of Large Language Models – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2503.09326

115. [2410.16676] CausalEval: Towards Better Causal Reasoning in Language Models – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2410.16676

116. Improving Causal Reasoning in Large Language Models: A Survey – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2410.16676v3

117. Accepted Main Conference Papers – ACL 2024, acessado em abril 22, 2025, https://2024.aclweb.org/program/main_conference_papers/

118. AI Safety Should Prioritize the Future of Work – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2504.13959v1

119. A Survey of Artificial Intelligence Challenges: Analyzing the Definitions, Relationships, and Evolutions – MDPI, acessado em abril 22, 2025, https://www.mdpi.com/2076-3417/12/8/4054

120. Future Shock: Generative AI and the International AI Policy and Governance Crisis, acessado em abril 22, 2025, https://hdsr.mitpress.mit.edu/pub/yixt9mqu

121. Scopes of Alignment – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2501.12405v1

122. AI alignment – Wikipedia, acessado em abril 22, 2025, https://en.wikipedia.org/wiki/AI_alignment

123. [2502.09288] AI Safety for Everyone – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2502.09288

124. Framework Convention on Global AI Challenges – Centre for International Governance Innovation (CIGI), acessado em abril 22, 2025, https://www.cigionline.org/documents/2688/AI-challenges_OW6rTMD.pdf

125. AI Safety Should Prioritize the Future of Work – arXiv, acessado em abril 22, 2025, https://www.arxiv.org/pdf/2504.13959

126. When Autonomy Breaks: The Hidden Existential Risk of AI – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2503.22151

127. The Alignment Problem in Context – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2311.02147

128. What Is Artificial General Intelligence: A 2025 Beginner’s Guide – eWEEK, acessado em abril 22, 2025, https://www.eweek.com/artificial-intelligence/artificial-general-intelligence/

129. Artificial General Intelligence (AGI) – Unaligned Newsletter, acessado em abril 22, 2025, https://www.unaligned.io/p/artificial-general-intelligence-agi

130. What is AGI? – Artificial General Intelligence Explained – AWS, acessado em abril 22, 2025, https://aws.amazon.com/what-is/artificial-general-intelligence/

131. Artificial General Intelligence Issues and Opportunities Abstract – the United Nations, acessado em abril 22, 2025, https://www.un.org/digital-emerging-technologies/sites/www.un.org.techenvoy/files/GDC-submission_the-millennium-project.pdf

132. Examples of Artificial General Intellgence (AGI) – IBM, acessado em abril 22, 2025, https://www.ibm.com/think/topics/artificial-general-intelligence-examples

133. Artificial General Intelligence – The Decision Lab, acessado em abril 22, 2025, https://thedecisionlab.com/reference-guide/computer-science/artificial-general-intelligence

134. Is neuro-symbolic AI meeting its promises in natural language processing? A structured review – IOS Press, acessado em abril 22, 2025, https://content.iospress.com/articles/semantic-web/sw223228

135. Neuro-Symbolic AI: Explainability, Challenges, and Future Trends – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2411.04383v1

136. (PDF) Neuro-Symbolic AI: Explainability, Challenges, and Future Trends – ResearchGate, acessado em abril 22, 2025, https://www.researchgate.net/publication/385629948_Neuro-Symbolic_AI_Explainability_Challenges_and_Future_Trends

137. Neuro-Symbolic AI in 2024: A Systematic Review – CEUR-WS.org, acessado em abril 22, 2025, https://ceur-ws.org/Vol-3819/paper3.pdf

138. Rethinking Theory of Mind Benchmarks for LLMs: Towards A User-Centered Perspective, acessado em abril 22, 2025, https://arxiv.org/html/2504.10839v1

139. Theory of Mind and Preference Learning at the Interface of Cognitive Science, Neuroscience, and AI: A Review – PMC – PubMed Central, acessado em abril 22, 2025, https://pmc.ncbi.nlm.nih.gov/articles/PMC9038841/

140. [2303.11594] A Review on Machine Theory of Mind – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2303.11594

141. [2411.09169] Artificial Theory of Mind and Self-Guided Social Organisation – arXiv, acessado em abril 22, 2025, https://arxiv.org/abs/2411.09169

142. Spontaneous Theory of Mind for Artificial Intelligence – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2402.13272v1

143. The Alignment Problem from a Deep Learning Perspective – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2209.00626v6

144. Beyond Preferences in AI Alignment – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2408.16984v1

145. The Alignment Problem from a Deep Learning Perspective – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2209.00626

146. \system: A Framework of Fundamental Values for Human-AI Alignment – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2409.09586v1

147. Rethinking AI cultural alignment – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2501.07751v2

148. Consciousness in Artificial Intelligence: Insights from the Science of Consciousness arXiv:2308.08708v3 [cs.AI] 22 Aug 2023, acessado em abril 22, 2025, https://arxiv.org/pdf/2308.08708

149. What Is AI safety? What Do We Want It to Be? – PhilArchive, acessado em abril 22, 2025, https://philarchive.org/archive/HARWIA-15

150. smartdev.com, acessado em abril 22, 2025, https://smartdev.com/addressing-ai-bias-and-fairness-challenges-implications-and-strategies-for-ethical-ai/#:~:text=The%20primary%20challenges%20include%20biased,of%20preventing%20bias%20will%20increase.

151. Addressing AI Bias and Fairness: Challenges, Implications, and Strategies for Ethical AI, acessado em abril 22, 2025, https://smartdev.com/addressing-ai-bias-and-fairness-challenges-implications-and-strategies-for-ethical-ai/

152. Ethical AI: Addressing bias, fairness, and accountability in autonomous decision-making systems – World Journal of Advanced Research and Reviews, acessado em abril 22, 2025, https://wjarr.com/sites/default/files/WJARR-2024-2510.pdf

153. AI Ethics in Focus: Addressing Bias, Privacy, and Transparency Challenges – Human Made, acessado em abril 22, 2025, https://humanmade.com/ai/ethics-in-ai/

154. Toward Fairness, Accountability, Transparency, and Ethics in AI for Social Media and Health Care: Scoping Review – PMC, acessado em abril 22, 2025, https://pmc.ncbi.nlm.nih.gov/articles/PMC11024755/

155. Ethical Considerations of AI | What Purpose do Fairness Measures Serve in AI? | Lumenalta, acessado em abril 22, 2025, https://lumenalta.com/insights/ethical-considerations-of-ai

156. Generative AI and the problem of existential risk – arXiv, acessado em abril 22, 2025, https://arxiv.org/pdf/2407.13365

Perceptions of Sentient AI and Other Digital Minds: Evidence from the AI, Morality, and Sentience (AIMS) Survey – arXiv, acessado em abril 22, 2025, https://arxiv.org/html/2407.08867v3
...
Fonte original: https://blog.elzobrito.com/as-quatro-ondas-da-inteligencia-artificial-uma-analise-profunda-do-passado-presente-e-futuro-cognitivo-e-economico/
