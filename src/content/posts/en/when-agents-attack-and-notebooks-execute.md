---
title: "When context starts to act"
description: "An agent-driven intrusion and code execution in research notebooks show why context, action, and isolation now belong in the same design conversation."
published: 2026-07-17
locale: en
translation: quando-agentes-atacam-e-cadernos-executam
tags: ["AI", "Security", "Agents", "Tools"]
featured: false
---
...
On the productive side of the same boundary, Google announced that [NotebookLM is becoming Gemini Notebook](https://blog.google/innovation-and-ai/products/gemini-notebook/notebooklm-gemini-notebook/). Beyond the new name and planned integration with other Gemini products, the technical addition is a secure cloud computer that can run code inside notebooks. The feature is beginning to roll out to Pro users.
