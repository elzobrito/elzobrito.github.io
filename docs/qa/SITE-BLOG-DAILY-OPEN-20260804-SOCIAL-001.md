# Social — SITE-BLOG-DAILY-OPEN-20260804

Data editorial: 2026-08-04 (America/Sao_Paulo)

## Pré-condição

- Publicação PT validada: https://elzobrito.github.io/blog/voz-local-ganha-novo-modelo-mas-perde-compatibilidade/
- Publicação EN validada: https://elzobrito.github.io/en/blog/local-voice-gains-a-new-model-but-loses-compatibility/
- Não havia URL pública prévia de LinkedIn ou X para esta data na memória da automação nem nos documentos QA.
...
Rever a memória e este documento imediatamente antes de cada envio. Usar somente uma sessão do Chrome já autenticada; publicar apenas o canal que ainda não tiver URL pública canônica. A tarefa SOCIAL permanece em andamento até que ambos os URLs sejam registrados.
